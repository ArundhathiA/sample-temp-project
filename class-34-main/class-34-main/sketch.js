...
function preload()
{
  ...
  board1 = loadAnimation('board1.png');
  ...
  coin1 = loadImage("coin22.png");
  coin2 = loadImage("coin22.png");
  coin3 = loadImage("coin22.png");
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   coin11 = createSprite(300,600,35,35);
   coin11.addImage(coin1);
   coin11.scale = 0.03;

   coin22 = createSprite(400,600,35,35);
   coin22.addImage(coin2);
   coin22.scale = 0.03;

   coin33 = createSprite(500,600,35,35);
   coin33.addImage(coin3);
   coin33.scale = 0.03;
  ...
  starA = createSprite(320,40,20,20);
  starA.addImage(star1);
  starA.scale = 0.02;

  starB = createSprite(70,360,20,20);
  ...
  board11 = createSprite(160,15,30,30);
  board11.scale = 0.2;
  board11.addAnimation("board",board1);
  //board11.addAnimation("coinA",coin1);
  //board11.addAnimation("coinB",coin2);
  //board11.addAnimation("coinC",coin3);
  //board11.changeAnimation("board");
...
function draw() 
{
  ...
  if(bunny.isTouching(coin11)){
    coin11.destroy()
    //coinA.changeAnimation("fillcoin1.png");
  }

  
  if(bunny.isTouching(coin22)){
    coin22.destroy()
    //coinB.changeAnimation("fillcoin2.png");
  }

  
  if(bunny.isTouching(coin33)){
    coin33.destroy()
    //coinC.changeAnimation("fillcoin3.png")
  }
